...
function Navbar(props) {
  ...
  const navlinkstyle = 
  "no-underline font-Montserrat hover:bg-brandText hover:text-brandBackground py-1 px-4 mx-4 active:bg-brandAccent transition duration-300 cursor-pointer rounded-md"

  return (
    <nav className="top-1 z-40 flex items-center justify-between px-3 shadow-md bg-white">
